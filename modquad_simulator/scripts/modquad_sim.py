...
from modsim.controller import position_controller, modquad_torque_control, controller_GeometricSO3
from modsim.trajectory import circular_trajectory, min_snap_trajectory, trajectory_GeometricSO3
...
def simulate():
    ...
    while not rospy.is_shutdown():
        ...
        F_single, M_single, dx  = controller_GeometricSO3(state_vector,trajectory_GeometricSO3(t))
        ...
        # Simulate
        state_vector = simulation_step(structure, state_vector, F_single, M_single, 1. / freq, dx)
        # state_vector[-1] = 0.01-state_vector[-1]

        print(t, state_vector[0:3])
